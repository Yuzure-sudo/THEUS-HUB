...
function Update:Window(text,logo,keybind)
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
    ...
    UserImage.Image = "rbxassetid://15525577762"
	...
	Logo.Image = "rbxassetid://15525577762"
...
NguyenTien:AddLabel("Fodasse")
NguyenTien:AddLabel("Ui: minha chibata")
...
setclipboard("https://discord.gg/embreve")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
NguyenTien:AddButton("YouTube numtem",function()
setclipboard("https://youtube.com/numtem")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
NguyenTien:AddButton("Facebook Official Owner",function()
setclipboard("https://www.facebook.embreve")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
---- Trang Chá»§
